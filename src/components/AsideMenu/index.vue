<template>
  <transition name="fadeIn">
      <div class="aside-menu">
        ...
        <div class="aside">
          <div class="info" :style="{backgroundColor: skinColor}">
            <img src="https://microzz.com/img/avatar.jpg" alt="microzz.com">
            <div class="about">
              <span class="name"><a href="#">xxx</a></span>
          ...
          <div class="settings">
            <div class="content">
              ...
              <ul>
                <li @click.stop.prevent="$store.commit('changeShowIndex', false)"><i class="icon-skin"></i>个性换肤</li>
...
export default {
  ...
  computed: {
    ...
    skinColor () {
      return this.$store.state.basicStore.skinColor
    }
  },
  methods: {
    showAsideMenu () {
